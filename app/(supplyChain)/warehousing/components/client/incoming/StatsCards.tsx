...
export function StatsCards({ scanned, topCourier }: StatsCardsProps) {
    return (
        <div className="grid grid-cols-2 gap-3 sm:gap-4 self-center w-full">
            <div className="bg-slate-50/80 border border-slate-200/80 hover:bg-slate-50 hover:border-slate-300 transition-all p-3.5 sm:p-4 rounded-2xl text-center flex flex-col items-center justify-center shadow-xs">
            ...
            <div className="bg-slate-50/80 border border-slate-200/80 hover:bg-slate-50 hover:border-slate-300 transition-all p-3.5 sm:p-4 rounded-2xl text-center flex flex-col items-center justify-center shadow-xs">
                ...
                <div
                    className="text-xl sm:text-2xl font-black text-pink-600 tracking-tight mt-1 truncate max-w-full px-1"

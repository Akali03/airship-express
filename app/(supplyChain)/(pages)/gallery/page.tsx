                        ...
                        <div className="bg-white dark:bg-ink rounded-2xl border border-slate-200/80 dark:border-ink/20 p-4 shadow-2xs space-y-4 animate-in fade-in duration-200">
                            ...
                            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
                                ...
                                <div>
                                    ...
                                    <div className="min-h-[38px] p-1 bg-slate-50/50 dark:bg-slate-800/20 rounded-xl border border-slate-100 dark:border-ink/20 flex flex-wrap items-center gap-1.5">
                                        {filterState.selectedCategory !== 'All' && (
                                            <span className="inline-flex items-center gap-1 px-2.5 py-1 rounded-lg text-xs font-semibold bg-pink-50 dark:bg-pink-950/30 text-pink-700 dark:text-pink-400 border border-pink-200/60 dark:border-pink-800/30 shadow-2xs">
                                                ...
                                                <button
                                                    ...
                                                    className="p-0.5 hover:bg-pink-100/80 dark:hover:bg-pink-900/30 rounded transition-colors text-pink-600 dark:text-pink-400 cursor-pointer"
                                        ...
                                        {filterState.searchTerm && (
                                            <span className="inline-flex items-center gap-1 px-2.5 py-1 rounded-lg text-xs font-semibold bg-slate-100 dark:bg-slate-800/50 text-slate-700 dark:text-slate-300 border border-slate-200 dark:border-ink/20 shadow-2xs">
                                                <span className="truncate max-w-[100px]">"{filterState.searchTerm}"</span>
                                                <button
                                                    onClick={() => {
                                                        handleFilterChange('searchTerm', '');
                            ...
                            return (
                                ...
                                >
                                    <div className="relative aspect-square overflow-hidden bg-slate-100 dark:bg-slate-950/60">
                                        {isLoading && !hasError && (
                                            <div className="absolute inset-0 animate-pulse bg-gradient-to-r from-slate-200 dark:from-slate-800 via-slate-100 dark:via-slate-700 to-slate-200 dark:to-slate-800" />
                                        )}
                            ...
                            return (
                                ...
                                >
                                    <div className="flex items-center gap-3.5 sm:gap-4 flex-1 min-w-0">
                                        <div className="relative w-16 h-12 sm:w-20 sm:h-14 rounded-xl bg-slate-100 dark:bg-slate-800/80 border border-slate-200/60 dark:border-white/10 flex-shrink-0 overflow-hidden shadow-2xs group-hover:border-pink-300 dark:group-hover:border-pink-500/40 transition-colors">
                                            {isLoading && !hasError && (
                                                <div className="absolute inset-0 animate-pulse bg-gradient-to-r from-slate-200 dark:from-slate-800 via-slate-100 dark:via-slate-700 to-slate-200 dark:to-slate-800" />
                                            )}
                                            {!hasError ? (
                                        ...
                                        <div className="min-w-0 flex-1">
                                            <div className="flex items-center gap-2 flex-wrap">
                                                ...
                                                {item.po_number && (
                                                    <span className="px-2 py-0.5 rounded-md bg-slate-100 dark:bg-slate-800/90 text-slate-500 dark:text-slate-300 font-mono text-[10px] font-semibold border border-slate-200/60 dark:border-white/10 flex-shrink-0">
                                                        PO: {item.po_number}
                                                    </span>
                                                )}
                                            </div>
                                    ...
                                    <div className="flex items-center gap-3 sm:gap-5 text-xs flex-shrink-0">
                                        ...
                                        <div className="flex items-center text-slate-400 dark:text-slate-400 hidden md:flex font-medium text-[11px]">
                ...
                {!loading && mediaItems.length > 0 && (
                    <div className="flex flex-col items-center justify-center py-10 gap-3">
                        {hasMore ? (
                            ...
                            <div className="text-xs sm:text-sm font-medium text-slate-600 dark:text-slate-300 flex items-center gap-2 bg-white/80 dark:bg-slate-900/80 backdrop-blur-md px-5 py-2.5 rounded-2xl border border-slate-200/80 dark:border-emerald-800/30 bg-emerald-50/30 dark:bg-emerald-950/20 shadow-2xs">
                    ...
                    >
                        ...
                        >
                            ...
                            <div className="flex-1 overflow-y-auto custom-scrollbar dark:scrollbar-thumb-slate-800">
                                <div className="relative flex-1 min-h-[380px] sm:min-h-[460px] flex items-center justify-center p-6 bg-slate-950 dark:bg-black group selection:bg-none overflow-hidden">

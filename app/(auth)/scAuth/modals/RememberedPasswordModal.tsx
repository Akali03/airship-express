                    ...
                    >
                        <div className="flex-1 min-h-0 overflow-y-auto p-5 sm:p-6 custom-scrollbar">
                            <div className="text-center mb-5 sm:mb-6">
                                ...
                                <h3 className="text-lg sm:text-xl font-bold text-slate-900 dark:text-white font-bricolage">Login as {selectedEmployee.display_name}</h3>
                            ...
                            <div className="mb-4 p-3.5 sm:p-4 bg-[#EAF0F6] dark:bg-[#13161F] shadow-[inset_3px_3px_6px_#cbd6e4,inset_-3px_-3px_6px_#ffffff] dark:shadow-[inset_3px_3px_8px_rgba(0,0,0,0.6),inset_-2px_-2px_6px_rgba(255,255,255,0.02)] rounded-2xl border border-white/40 dark:border-white/[0.06]">
                                ...
                                <p className="font-semibold text-slate-900 dark:text-white text-sm sm:text-base mt-0.5">{selectedEmployee.display_name}</p>
                                <p className="text-xs sm:text-sm text-slate-600 dark:text-slate-300 break-all">{selectedEmployee.email}</p>
                                {selectedEmployee.employee_id && (
                                    <p className="text-xs text-slate-500 dark:text-slate-400 mt-1">ID: {selectedEmployee.employee_id}</p>
                                )}
                                {selectedEmployee.department && (
                                    <p className="text-xs text-slate-500 dark:text-slate-400">{selectedEmployee.department} • {selectedEmployee.position}</p>
                                )}
